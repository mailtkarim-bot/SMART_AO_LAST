...
class AuditEventType(StrEnum):
    ...
    AUTH_MFA_ENROLLMENT_STARTED = "AUTH_MFA_ENROLLMENT_STARTED"
    AUTH_MFA_ENROLLMENT_CONFIRMED = "AUTH_MFA_ENROLLMENT_CONFIRMED"
    AUTH_MFA_VERIFICATION_DENIED = "AUTH_MFA_VERIFICATION_DENIED"
    AUTH_MFA_STEP_UP_SUCCEEDED = "AUTH_MFA_STEP_UP_SUCCEEDED"
    AUTH_MFA_RECOVERY_USED = "AUTH_MFA_RECOVERY_USED"
    AUTH_MFA_RECOVERY_COMPLETED = "AUTH_MFA_RECOVERY_COMPLETED"
    AUTH_MFA_DISABLED = "AUTH_MFA_DISABLED"
    SUBMISSION_PACKAGE_EXPORTED = "SUBMISSION_PACKAGE_EXPORTED"
