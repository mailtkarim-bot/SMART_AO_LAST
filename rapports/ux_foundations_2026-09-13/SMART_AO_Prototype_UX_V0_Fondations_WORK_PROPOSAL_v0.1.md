...
**Statut : WORK PROPOSAL — proposition de contrat produit/UX, à arbitrer puis matérialiser.**  
**Autorités : Cahier directeur Produit & Métier OWNER_CONSOLIDATED v0.4, puis Catalogue UX OWNER_CONSOLIDATED v0.3.**

## 0. Objet, portée et règle de lecture

Ce document définit comment SMART AO doit se présenter et se comporter avant la fabrication des maquettes détaillées. Il couvre les fondations partagées par les 104 contrats de surface : shell, navigation, densité, langage métier, états, preuve, autorité, confidentialité, assistance IA et adaptation aux écrans.

Le [catalogue UX propriétaire v0.3](../../docs/00_REFERENCE_ACTIVE/SMART_AO_Catalogue_Ecrans_Parcours_Produit_OWNER_CONSOLIDATED_v0.3.md) fait foi pour C00, C01–C16, N01–N05, PUX-01–PUX-19, les huit corrections UX-C1 et les douze innovations I01–I12. Le [cahier produit v0.4](../../docs/00_REFERENCE_ACTIVE/SMART_AO_Cahier_Directeur_Produit_Metier_OWNER_CONSOLIDATED_v0.4.md) reste supérieur sur le métier, les droits, les portes P0–P7 et l’autorité. Le présent document applique ces décisions ; il ne les rouvre pas silencieusement.^1
...
### P2. Améliorations proposées dans le cadre adopté

| ID | Proposition | Valeur attendue | Risque / arbitrage UX à tester |
|---|---|---|---|
| PROP-01 | Rail global + barre supérieure + bandeau Affaire collant | Contexte stable malgré navigation profonde | Hauteur consommée sur laptop ; tester bandeau sur une/deux lignes |
| PROP-02 | Une action principale et microcopy verbe+objet+version | Réduction des clics ambigus | Libellés longs ; tester compréhension plutôt que compacité seule |
| PROP-03 | Preuve à un geste, document à deux | Vérification rapide sans perdre la liste | Panneau trop étroit ; bascule automatique vers mode large |
| PROP-04 | Grammaire métier à cinq signaux | Compréhension sans dépendance couleur | Trop de marqueurs ; tester reconnaissance sur cas réels |
| PROP-05 | Onglets Accueil À faire/À surveiller/Événements | Sépare priorité, surveillance et récence | Condition ancienne oubliée ; persistance hors onglet événements |
| PROP-06 | Filtres C05 par conséquence métier | Répond à « qu’est-ce qui bloque ? » | Un objet peut toucher plusieurs portes ; multi-étiquetage explicite |
| PROP-07 | Actualisation IA ciblée sur les changements | Moins de bruit, délai et usage | Bref incomplet ; afficher portée et accès au recalcul complet autorisé |
| PROP-08 | Transformation responsive liste/détail | Conserve la lisibilité sans miniature de desktop | Retour de contexte fragile ; prototype navigation arrière et focus |
| PROP-09 | Échelle d’espacement et grille définies dès V0 | Cohérence entre prototypes | Ne pas figer prématurément la direction visuelle de marque |

### P3. Proposition de réouverture propriétaire

**Aucune.** La recherche ne fournit pas de preuve assez forte pour rouvrir les cinq espaces, le dépôt final humain V1, l’autorité humaine, la confidentialité Direction, le mobile compagnon, les portes P0–P7 ou la frontière chiffrage/ERP. Les limites observées renforcent au contraire ces garde-fous.
...
## Q — Ordre exact des premières maquettes

Chaque étape produit une vue normale et les variantes indiquées. Le prototype suivant ne commence pas si le précédent conserve une ambiguïté d’autorité, de preuve ou de reprise.

1. **V0-01 — Shell desktop laptop** : rail, barre, bandeau Affaire, cinq destinations, panneau et mode large. Variantes : lien direct, changement de lot, données longues, clavier et 1366 × 768.
2. **V0-02 — Système visuel métier/C00** : planche de tous les objets K1, états F8, actions, preuve, échéances et droits. Tester en niveaux de gris et avec lecteurs métier.
3. **V0-03 — Accueil commun / Patron** : La minute Patron avec trois décisions, condition ancienne, preuve et délégation ; droits Direction autorisés.
4. **V0-04 — Accueil Responsable/Expert** : même architecture, compositions différentes ; zéro carte interdite et aucune fuite par compteur.
5. **V0-05 — C05 À résoudre normal** : liste, filtres, panneau, tâche liée et source ; exigence/contradiction/inconnu/risque/tâche simultanés.
6. **V0-06 — C05 états** : partiel, droits limités, filtre vide, à revalider et IA indisponible ; retour à la même ligne après ouverture de C06.
7. **V0-07 — Panneau preuve + C06 comparaison** : source à un geste, document à deux, comparaison v2/v3 et impacts confirmés/non interprétés.
8. **V0-08 — N01 conflit** : deux contributions, résolution, motif, effets à revalider ; clavier et version non écrasée.
9. **V0-09 — N02 résultat non confirmé** : autorisation, export et upload ; vérifier avant réessai ; sortie/quitter sans perte.
10. **V0-10 — C11 Candidate** : manifeste, fichiers, signatures, modifications depuis P4 et nouvelle candidate après changement.
11. **V0-11 — C11 Contrôles/P5** : B0/B1/B2, page de vérification, step-up, autoriser v7, retour si v8 apparaît.
12. **V0-12 — C11 Transmission/Réception** : dépôt humain, déclaration, reçu absent, incohérent, partiel et complet ; historique/redépôt.
13. **V0-13 — Confidentialité croisée** : même Accueil/C05/C08/C11 pour Patron, Responsable, Métreur, DAF, Admin et tiers ; recherche/notification/export/IA inclus.
14. **V0-14 — IA contextuelle** : briefing, pourquoi, suggestion, transformation contradiction→question, rejet, revue et panne.
15. **V0-15 — Responsive** : laptop étroit, tablette liste→détail, mobile visite hors ligne et captures N05 ; fonctions volontairement indisponibles.
16. **V0-16 — Parcours V1 de fondation** : C15 → C01 → C03 → C06 → C05, avec MFA, première valeur, panne et reprise. Ce parcours vérifie que les composants V0 tiennent ensemble.

### Q1. Critères de sortie de V0
...
Ces critères sont des conditions de recette future, pas des résultats déjà obtenus. Après validation de V0, les prototypes suivants reprennent l’ordre propriétaire V1–V6 du catalogue v0.3 et couvrent l’intégralité des 104 IDs, PUX-01–19 et G01–G52.
...
La prochaine étape est une validation propriétaire des propositions PROP-01–PROP-09, suivie de V0-01. Le Product Freeze et l’UX Freeze restent non déclarés.
