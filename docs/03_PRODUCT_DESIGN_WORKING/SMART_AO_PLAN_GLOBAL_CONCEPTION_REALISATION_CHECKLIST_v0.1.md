...
**Prochaine étape unique :** étendre la qualification locale aux scénarios de charge, reprise et incidents, en conservant les limites VPS.
...
| 21/09/2026 | Harness local préproduction reproductible | `scripts/simulate_preprod_local.sh` crée un environnement éphémère, remplace les ports Caddy occupés, construit et démarre le stack complet, attend HTTPS/DB/schema/ClamAV, sauvegarde PostgreSQL, restaure dans une base isolée, vérifie 127 tables et la tête `20260920_0090`, simule la rotation JWT en fichier `0600`, puis nettoie conteneurs, volumes et secrets temporaires ; exécution complète réussie | étendre la qualification locale aux scénarios de charge, reprise et incidents |
