...
**Prochaine étape unique :** qualifier le chemin natif restant et préparer un corpus d’activation avant toute réouverture OCR/Docling/RAG.
...
| 21/09/2026 | Décision d’activation des dépendances optionnelles | OCR/RapidOCR, Docling/PyMuPDF et RAG/sentence-transformers restent `DIFFÉRÉS` ; aucun modèle ni extra n’est installé ; décision `SMART_AO_PHASE11_OPTIONAL_DEPENDENCIES_DECISION_v0.1.md` et note Basic Memory ; réouverture conditionnée à un corpus approuvé, modèles vérifiés et budget mémoire | qualifier le chemin natif restant et préparer un corpus d’activation avant toute réouverture OCR/Docling/RAG |
