...
**Prochaine étape unique :** relier les preuves G01–G09 aux actes métier encore manquants : résolution humaine G03, décision P3/P5 G01/G02, édition dérivée G05 et revue propriétaire G04/G06.
...
- [>] Exécuter G01 à G52 avec les rôles et états difficiles applicables ; fixtures G01–G09 versionnées et rejouées dans `backend/app/platform/quality/data/g01_g09_business.json` / `backend/tests/application/test_g01_g09_business_fixtures.py`, mais actes métier encore ouverts ; preuve dans `SMART_AO_PHASE9_G01_G09_EXECUTION_PREUVE_v0.1.md`, matrice dans `SMART_AO_PHASE9_G01_G52_EXECUTION_MATRIX_v0.1.md` et registre structuré dans `backend/app/platform/quality/data/g01_g52.json`.
