...
- qualification backend complète après installation des extras : 1 718 tests passent, 2 échecs initiaux proviennent uniquement de l’extra calendrier retiré par la synchronisation uv ; `icalendar`/`tzdata` restaurés et les 2 tests ciblés passent, soit une couverture effective verte sur les 1 720 tests collectés ;
