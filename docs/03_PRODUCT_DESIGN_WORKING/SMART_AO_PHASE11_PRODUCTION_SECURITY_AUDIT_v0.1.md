...
- `scripts/simulate_preprod_local.sh` rejoue désormais cette qualification en une commande : build/start complet, smoke HTTPS, 20 requêtes concurrentes, redémarrage backend/frontend/PostgreSQL, panne ClamAV visible puis récupération, backup PostgreSQL, restauration isolée de 127 tables à la tête `20260920_0090`, rotation JWT éphémère `0600` et nettoyage automatique ; exécution réussie ;
