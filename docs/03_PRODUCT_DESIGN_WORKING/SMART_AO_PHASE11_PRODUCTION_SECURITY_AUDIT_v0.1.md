...
- la qualification optionnelle passe 9 tests avancés sans skip PIL après installation ; PyMuPDF traite une fixture PDF locale en 9,2 ms ; Docling est importable mais ses modèles layout/vision manquent et le téléchargement Hugging Face échoue par DNS ; RapidOCR refuse sans chemins de modèles locaux ; sentence-transformers/Torch s’importent, mais l’embedding BGE CPU n’est pas forcé sous la pression mémoire ;
