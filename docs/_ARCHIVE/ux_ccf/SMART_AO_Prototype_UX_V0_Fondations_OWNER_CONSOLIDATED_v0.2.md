...
## OWNER_CONSOLIDATED v0.2

**Date : 13 septembre 2026**  
**Statut : RÉFÉRENCE UX PROPRIÉTAIRE ACTIVE POUR LA FABRICATION ET LA VALIDATION DES PROTOTYPES V0 — propositions Work arbitrées ; PROP-01 à PROP-09 adoptées ; aucune réouverture métier.**  
**Autorités supérieures : Cahier directeur Produit & Métier OWNER_CONSOLIDATED v0.4, puis Catalogue UX OWNER_CONSOLIDATED v0.3.**  
**Source absorbée : `SMART_AO_Prototype_UX_V0_Fondations_WORK_PROPOSAL_v0.1.md` — conservée comme preuve de recherche et de conception, non comme référence active.**

## 0. Objet, portée et règle de lecture

Ce document définit désormais **la référence propriétaire de V0** : comment SMART AO doit se présenter et se comporter avant et pendant la fabrication des premières maquettes détaillées. Il couvre les fondations partagées par les 104 contrats de surface : shell, navigation, densité, langage métier, états, preuve, autorité, confidentialité, assistance IA et adaptation aux écrans.

Le [catalogue UX propriétaire v0.3](../../docs/00_REFERENCE_ACTIVE/SMART_AO_Catalogue_Ecrans_Parcours_Produit_OWNER_CONSOLIDATED_v0.3.md) fait foi pour C00, C01–C16, N01–N05, PUX-01–PUX-19, les huit corrections UX-C1 et les douze innovations I01–I12. Le [cahier produit v0.4](../../docs/00_REFERENCE_ACTIVE/SMART_AO_Cahier_Directeur_Produit_Metier_OWNER_CONSOLIDATED_v0.4.md) reste supérieur sur le métier, les droits, les portes P0–P7 et l’autorité. Le présent OWNER_CONSOLIDATED v0.2 applique ces décisions et **remplace le WORK_PROPOSAL v0.1 comme source active de conception V0** ; toute contradiction éventuelle se résout en faveur des autorités supérieures.^1
...
| ID | Décision propriétaire | Statut v0.2 |
|---|---|---|
...
3. **le présent `SMART_AO_Prototype_UX_V0_Fondations_OWNER_CONSOLIDATED_v0.2.md`** — autorité de fondations visuelles et interactionnelles V0 ;
4. maquettes/prototypes V0 validés — matérialisation de ces contrats, sans pouvoir les réécrire silencieusement.

Le fichier Work v0.1 est archivé comme **source de recherche, benchmark et raisonnement de conception**. Il ne fait plus foi en cas d’écart avec la présente version.
...
## Q — Ordre propriétaire exact des premières maquettes

Cet ordre est **adopté pour V0**. Chaque étape produit une vue normale et les variantes indiquées. Le prototype suivant ne commence pas si le précédent conserve une ambiguïté d’autorité, de preuve ou de reprise.
...
Les propositions PROP-01–PROP-09 sont désormais **arbitrées et adoptées** dans la présente version. La prochaine étape est **V0-01 — Shell desktop/laptop**, puis la séquence V0-02 à V0-16. Le Product Freeze et l’UX Freeze restent non déclarés : seules les fondations documentaires V0 sont consolidées.


---

## R — Registre propriétaire de statut V0 v0.2

| Élément | Statut |
|---|---|
| WORK_PROPOSAL v0.1 | **ABSORBÉ / ARCHIVE DE CONCEPTION** |
| OWNER_CONSOLIDATED v0.2 | **RÉFÉRENCE ACTIVE V0** |
...
| V0-01 à V0-16 | **ORDRE DE PROTOTYPAGE ADOPTÉ** |
...
- **révision UX v0.2.x** si le comportement change sans toucher au métier ;
...
La prochaine sortie est **V0-01 — Shell desktop/laptop**, matérialisée visuellement à partir de B1–B5, F1–F8, K1–K6 et N1, avec ses variantes de lien direct, changement de lot, données longues, clavier et résolution de référence 1366 × 768.

---

**Fin — SMART AO — Fondations UX du prototype V0 — OWNER_CONSOLIDATED v0.2**
