...
## Owner Consolidated — v0.4

**Date : 13 septembre 2026**  
**Révision : v0.4-R1 — décision propriétaire d’étendre le prototypage à toute la surface UX V1**  
**Statut : OWNER CONSOLIDATED — contre-audit Work arbitré ; règles fonctionnelles adoptées ; Product Freeze v1.0 encore conditionné à la validation de la surface UX complète V1 et aux qualifications externes explicitement marquées W**  
...
> **Portée de v0.4.** Cette version consolide le socle propriétaire v0.2 et le contre-audit Work v0.3. Les décisions DEC-01–11 et OWN-01–13 restent propriétaires ; OWN-01 est amendée par décision v0.4 pour permettre la suspension du dernier Propriétaire compromis sans suppression de son identité. Les arbitrages A01–A08 sont tranchés dans la présente version. Les règles R01–R16, la matrice des profils, les recettes G01–G52 et les contrats E01–E12/S01–S02 sont adoptés comme contrat produit de référence pour le prototypage, sous réserve des mentions W, des paramètres explicitement qualifiés de valeurs par défaut et des validations juridiques ou de service indiquées.
>
> **Verdict propriétaire : GO vers prototypage UX complet de la V1 ; HOLD A2.** Le contre-audit est clos. Le propriétaire a décidé de ne pas limiter la validation visuelle aux 12 écrans structurants : **toute la surface fonctionnelle V1 de SMART AO doit être inventoriée, conçue visuellement et parcourue avant Product Freeze**. Les 12 contrats E01–E12 restent les pivots métier et les points de contrôle principaux ; S01/S02 et tous les parcours de support, sécurité, administration, gouvernance, partage, erreur et reprise doivent également être matérialisés. A2 demeure HOLD jusqu’au Product Freeze v1.0.
>
> **Lecture.** §§0–53 : socle propriétaire consolidé ; §54 : décisions de consolidation v0.4 ; §55 : règles R01–R16, profils et recettes adoptées ; §56 : contrats E01–E12 et surfaces S01/S02 adoptés pour prototypage ; §57 : sources et limites du contre-audit ; §58 : registre de fermeture vers Product Freeze v1.0. Les valeurs chiffrées de session, volumétrie, partage, conservation et reprise sont des paramètres produit ou objectifs de qualification, jamais des obligations légales par défaut.
>
...
Cette version constitue un **Owner Consolidated Freeze intermédiaire**. Le contre-audit Work est terminé et ses écarts ont été arbitrés. Le Product Freeze v1.0 sera prononcé après :
1. inventaire complet de la **surface UX V1** dans un catalogue dédié des écrans et parcours ;
2. conception/prototypage visuel de **tous les écrans et parcours fonctionnels V1**, avec priorité et profondeur adaptées ;
3. validation propriétaire approfondie des 12 écrans structurants E01–E12 et des surfaces transversales S01/S02 ;
4. validation de cohérence des parcours d’accès, sécurité, administration, Mémoire Entreprise, partage, erreur, reprise, export et clôture ;
5. clôture des qualifications W qui conditionnent une promesse commerciale, juridique, sécurité ou données ;
6. constat qu’aucun écart C1 produit ne reste non arbitré.
...
### Décision consolidée — OWN-01 / OWN-06
...
5. l’organisation conserve toujours au moins un **Propriétaire nominatif désigné** ;
6. en fonctionnement normal, au moins un Propriétaire est actif ;
7. en cas de compromission, perte d’accès ou incident de sécurité, l’accès du dernier Propriétaire peut être suspendu immédiatement sans supprimer son identité ni son historique ;
8. les opérations réservées restent alors bloquées jusqu’à récupération ou réattribution après preuve d’autorité organisationnelle ;
9. le support SMART AO ne devient jamais Patron, Propriétaire métier ou signataire du client du seul fait de cette récupération.

**Statut : F — OWN-01 amendée par décision v0.4 ; récupération exceptionnelle encadrée par R03**
...
Décision V1 :
- invitation nominative et à usage unique ;
- validité par défaut : **7 jours**, configurable sans modifier le contrat produit ;
- vérification de l’adresse ;
- acceptation explicite ;
- rôle et périmètre attribués avant accès ;
- MFA requis avant tout accès métier interne ;
- aucun domaine email commun imposé par défaut ;
- une invitation expirée peut être réémise sans créer de compte doublon ni restaurer automatiquement un ancien privilège.

**Statut : F sur le comportement et la valeur par défaut ; T sur l’implémentation**
...
- invitation nominative à usage unique : 7 jours par défaut ;
- inactivité session : 30 minutes par défaut ;
- durée absolue de session : 12 heures par défaut ;
- avertissement avant expiration lorsque l’écran est actif ;
- step-up lié à l’action et à la version, utilisable au plus 5 minutes et invalidé si cible ou droits changent ;
- récupération normale par facteur de secours préenregistré ou validation d’un Propriétaire habilité ;
- récupération exceptionnelle du dernier Propriétaire selon R03, après preuve d’autorité organisationnelle et journalisation ;
- révocation immédiate des sessions/facteurs compromis.

Ces durées sont des **paramètres produit initiaux configurables**, pas des obligations légales attribuées à l’ANSSI.

**Statut : F sur le comportement et les valeurs par défaut ; W lorsque la procédure exige une qualification juridique ; T sur les mécanismes techniques.**
...
# 11. Surface UX complète V1 à concevoir et valider

## 11.1 Décision propriétaire

Le propriétaire décide que SMART AO ne sera pas validé visuellement sur les seuls 12 écrans structurants.

Avant Product Freeze v1.0, **toute la surface fonctionnelle V1 du logiciel doit être inventoriée, conçue et prototypée à un niveau suffisant pour permettre une validation réelle du produit**.

Cette surface couvre notamment :
- écrans métier cœur ;
- accès, connexion, invitation, MFA, récupération et session ;
- organisation, utilisateurs, rôles, délégations et gouvernance ;
- Mémoire Entreprise et ses familles documentaires ;
- Opportunités / Radar ;
- Affaires ;
- DCE, documents, versions, rectificatifs, exigences et sources ;
- MIRP, risques, inconnus et contradictions ;
- prix, capacité et trésorerie ;
- production de réponse ;
- engagements ;
- Coffre, remise, reçus et redépôts ;
- partage externe ;
- résultat, REX et passation ;
- notifications, tâches, échéances et recherche ;
- administration, support, export, réversibilité et fermeture ;
- états d’erreur, blocage, reprise et indisponibilité IA ;
- variantes responsive/mobile prévues en V1.

## 11.2 Les 12 écrans structurants restent les pivots

Les contrats E01–E12 restent les **écrans structurants** et les références prioritaires du produit :
...
Ils ne constituent plus la liste exhaustive des prototypes à produire.

## 11.3 Catalogue complet à produire

Un document compagnon doit être créé :

> `SMART_AO_Catalogue_Ecrans_Parcours_Produit_v0.1.md`

Il deviendra l’inventaire maître de la surface UX V1 et devra, pour chaque écran/parcours, préciser au minimum :
- identifiant et nom ;
...
- source/preuve ;
- états vide, normal, traitement, partiel, erreur et bloqué ;
- reprise ;
- comportement si IA indisponible ;
- mobile/responsive si pertinent ;
- accessibilité ;
- critères d’acceptation observables ;
- priorité de prototypage.

## 11.4 Niveaux de fidélité

Tous les écrans V1 doivent être **conçus visuellement**, mais pas nécessairement avec la même profondeur dès le premier passage :

- **Niveau P1 — critique/structurant** : prototype détaillé et interactif lorsque cela éclaire le parcours ;
- **Niveau P2 — support important** : prototype fonctionnel complet, sans recherche pixel-perfect inutile ;
- **Niveau P3 — variantes/états/secondaires** : maquette fonctionnelle suffisante pour valider comportement, droits et reprise.

Le niveau de fidélité ne change jamais l’obligation de définir le comportement produit.

## 11.5 Règle de validation

Pour chaque écran, doivent être figés au minimum : rôle principal, question métier, informations essentielles, action principale, actions secondaires, états, erreur, reprise, confidentialité, preuve/source, accessibilité et comportement IA.

**Statut : F — décision propriétaire v0.4-R1**
...
Onboarding accompagné sans inscription publique libre : F — OWN-06.

Décision V1 :
- le provisioning est réalisé par SMART AO ou son automatisation opérée ;
- le premier Propriétaire active et confirme l’organisation ;
- l’onboarding guidé demande seulement les informations nécessaires à la première valeur ;
- la configuration fine de l’entreprise peut être progressive ;
- les droits initiaux sont explicites et revus avant l’invitation de collaborateurs ;
- le parcours self-service complet reste un objectif V1.x tant que l’onboarding accompagné apporte de la valeur aux premiers clients.
...
Les décisions produit générales sont désormais consolidées. Le produit sera promu en **Product Freeze v1.0** lorsque :

1. DEC-01 à DEC-11 restent figées ;
2. OWN-01 à OWN-13, y compris l’amendement OWN-01 v0.4, sont figées ;
3. le catalogue complet des écrans et parcours V1 est établi et validé ;
4. toute la surface UX V1 est matérialisée visuellement à un niveau de fidélité adapté ;
5. les contrats E01–E12 et surfaces S01/S02 sont matérialisés avec un niveau de détail prioritaire ;
6. le propriétaire valide les parcours, états, droits, erreurs, reprises, confidentialité et comportements IA de la surface UX complète ;
7. aucune contradiction C1 entre catalogue UX, contrats E01–E12/S01–S02, R01–R16 et périmètre V1 ne subsiste ;
8. les qualifications W qui conditionnent une promesse commerciale, une sécurité d’accès, une conservation de données ou une obligation juridique sont soit clôturées, soit explicitement exclues de la promesse V1 ;
9. le périmètre V1/V1.x reste inchangé ou toute modification est arbitrée explicitement ;
10. les recettes G01–G52 sont mappées aux écrans/parcours et aux futurs tests ; elles n’ont pas besoin d’être toutes exécutées sur le logiciel avant le Product Freeze, mais aucune recette critique ne doit être impossible par conception ;
11. les limites de formats et de volumétrie sont présentées comme objectifs de qualification tant qu’elles ne sont pas mesurées ;
12. le document final ne renvoie plus au cahier technique une décision qui change le comportement visible du produit.

Les deux pilotes terrain prévus par DEC-01 restent obligatoires **avant la mise sur le marché/pilote client réel**, mais ne bloquent pas la rédaction du cahier technique après validation propriétaire des prototypes. Toute découverte terrain matérielle donnera lieu à une révision versionnée du Product Freeze.

À satisfaction de ces conditions :
...
Le contre-audit Work est terminé et les arbitrages A01–A08 sont tranchés dans la présente v0.4.

À partir de maintenant :

- A1 Golden DCE peut être finalisé et gelé selon son protocole ;
- **A2 SourceAnchor reste HOLD** jusqu’au Product Freeze v1.0 ;
- aucune nouvelle étude générale Work n’est nécessaire ;
- le prochain chantier produit est la création du **Catalogue complet des écrans et parcours V1**, puis le prototypage visuel de toute la surface UX V1 ;
- les 12 écrans E01–E12 restent les pivots prioritaires ; S01/S02 et les parcours transversaux sont inclus dans la même campagne de conception ;
- les qualifications W juridiques/sécurité/données peuvent avancer en parallèle ;
- le cahier technique ne démarre qu’après Product Freeze v1.0 ;
- Codex peut continuer uniquement les travaux A1/autorisés qui ne transforment pas le cœur produit ;
- aucune règle historique V8 ne peut rouvrir une décision propriétaire consolidée.
...
# 54. Décisions de consolidation v0.4

Le contre-audit Work v0.3 est accepté comme base de fermeture. Les harmonisations M01–M08 sont adoptées. Les compléments M09–M17 sont intégrés comme exigences produit lorsque leur contenu relève du comportement utilisateur ; les mentions W et T restent réservées aux qualifications externes et à l’implémentation.

## 54.1 Arbitrages A01–A08

| ID | Décision v0.4 | Statut |
|---|---|---|
| **A01** | Adopter M01–M08, R01, minimum P6/P7 et précédence des décisions F sur toute proposition ultérieure. | **ACCEPTÉ — F** |
| **A02** | Adopter R02/R03 et amender OWN-01 : un Propriétaire nominatif demeure désigné, mais le dernier accès peut être suspendu en cas de compromission. Invitation 7 j, inactivité 30 min, session absolue 12 h, step-up 5 min comme defaults configurables. | **ACCEPTÉ / OWN-01 AMENDÉ — F** |
| **A03** | Adopter R04/R05, les portes P0–P7, classes B0/B1/B2, conditions de levée et invalidations ciblées. | **ACCEPTÉ — F** |
| **A04** | Adopter R06/R16 : PDF texte/scans, DOCX/XLSX qualifiés comme cible initiale ; anciens formats conservés avec parcours externe si fidélité non démontrée. Profil 500 fichiers / 2 Go / 200 Mo / archives profondeur 3 = **objectif de qualification**, pas promesse commerciale acquise. | **ACCEPTÉ — F + QUA** |
| **A05** | Adopter R09 : contribution/taux sur vente, coût inconnu ≠ zéro, minimum capacité/trésorerie, décisions sous hypothèse. | **ACCEPTÉ — F** |
| **A06** | Adopter R13 : autorité par contenu, destinataire vérifié, paquet exact révocable. Expiration partage 7 j et support exceptionnel 1 h = defaults configurables. | **ACCEPTÉ — F** |
| **A07** | Adopter R14 et sa matrice de gouvernance. Réversibilité 30 j, lien export 7 j, purge sauvegardes ≤90 j, journaux sécurité 12 mois = cibles de politique **à valider juridiquement et opérationnellement** avant promesse contractuelle. | **ACCEPTÉ — F/W** |
| **A08** | Adopter R15/R16 et les contrats E01–E12/S01–S02. Objectifs RPO/RTO 1 h / 4 h = objectifs de qualification, pas SLA acquis. | **ACCEPTÉ — F + QUA/W** |

## 54.2 Seule décision propriétaire amendée

OWN-01 est remplacée par l’exception de sécurité décrite dans A02. Toutes les autres décisions DEC/OWN restent inchangées.

## 54.3 Règle de statut

- Les **comportements produit** explicitement adoptés dans R01–R16 et E01–E12/S01–S02 deviennent normatifs pour la suite.
- Une **valeur chiffrée** explicitement qualifiée de default reste configurable.
- Une **valeur de performance/volumétrie/RPO/RTO** reste un objectif de qualification tant qu’elle n’est pas mesurée.
- Une règle marquée **à valider par spécialiste juridique** reste W jusqu’à conclusion tracée.
- Aucune technologie n’est choisie par cette adoption.

---

# 55. Règles fonctionnelles, rôles et recettes consolidés

## Statut consolidé

Les règles R01–R16 sont **adoptées comme contrat fonctionnel produit v0.4**. Elles ne choisissent aucune technologie. Lorsqu’une règle contient une valeur explicitement qualifiée de default ou d’objectif de qualification, cette valeur n’est pas une obligation légale ni une performance déjà démontrée. Toute mention « à valider par spécialiste juridique » reste W.

Les recettes G01–G52 deviennent le **catalogue officiel de recettes métier et adversariales** à mapper aux prototypes puis aux tests logiciels. Elles ne sont pas déclarées passantes à ce stade.
...
Décision v0.4 — réglages V1 par défaut : invitation nominative à usage unique valable 7 jours ; vérification de l'adresse, acceptation de l'invitation et MFA avant tout accès métier interne ; pas d'obligation de domaine email commun. Une invitation expirée peut être réémise sans ouvrir de compte doublon ni conserver un ancien privilège non revérifié.
...
**Décision propriétaire OWN-01 amendée v0.4 — exception de sécurité** : conserver un Propriétaire nominatif désigné, tout en autorisant la suspension immédiate de tout accès actif en cas de compromission du dernier compte. La récupération restaure ensuite l’accès après preuve d’autorité organisationnelle ; le support ne reçoit aucun pouvoir métier automatique.
...
Support : diagnostic par métadonnées minimales ; contenu inaccessible par défaut. Accès exceptionnel approuvé par l'autorité client correspondant aux données, nominatif, périmètre, motif et expiration ; décision v0.4 : 1 heure par défaut, renouvelable par nouvelle approbation. Accès fortement restreint soumis au step-up OWN-04. Un accord de l'Administrateur seul n'ouvre pas les marges. L'accès cesse à expiration/révocation et sa trace est fournie au client.[^15][^17]
...
# 56. Contrats fonctionnels consolidés pour prototypage

## E. Portée et invariants communs

Décision v0.4-R1 : les 12 écrans E01–E12 et les surfaces S01/S02 sont **adoptés comme contrats structurants prioritaires**, mais ils ne constituent plus la totalité de la surface à prototyper. Un catalogue complet des écrans/parcours V1 doit être créé et toute la surface fonctionnelle V1 doit être matérialisée visuellement. Le présent document ne constitue ni une maquette pixel-perfect, ni une spécification d’architecture, ni une recette déjà exécutée. Les futurs prototypes devront respecter E01–E12/S01–S02 et compléter les parcours secondaires sans les redéfinir silencieusement. Référence des règles : R01–R16 ; référence des recettes : G01–G52.
...
## Décision v0.4-R1 — les 12 écrans ne constituent plus la couverture UX exhaustive

**Les 12 écrans restent suffisants comme colonne vertébrale du cycle d’une Affaire, mais insuffisants comme représentation visuelle de tout le SaaS vendu.** Le propriétaire décide donc de concevoir la surface UX complète V1. La Mémoire Entreprise, l’Administration, l’identité/sécurité, les partages, exports, erreurs, reprises et autres parcours de support sont inclus dans le futur catalogue écrans/parcours. S01/S02 restent les premiers contrats transversaux de référence, sans limiter la liste finale.
...
# 58. Registre de fermeture vers Product Freeze v1.0

## 58.1 État au 13 septembre 2026

| Bloc | État |
|---|---|
| Vision / promesse / cible | **FERMÉ** |
| DEC-01–DEC-11 | **FERMÉ** |
| OWN-01–OWN-13 | **FERMÉ**, OWN-01 amendée v0.4 |
| Périmètre V1 / V1.x | **FERMÉ** |
| R01–R16 | **ADOPTÉS** |
| Profils utilisateurs | **ADOPTÉS** |
| G01–G52 | **CATALOGUE OFFICIEL DE RECETTES** |
| E01–E12 | **ADOPTÉS POUR PROTOTYPAGE** |
| S01/S02 | **ADOPTÉS POUR PROTOTYPAGE** |
| Contre-audit Work | **CLOS** |
| Catalogue complet écrans/parcours V1 | **À PRODUIRE / VALIDER** |
| Prototypage surface UX complète V1 | **À PRODUIRE / VALIDER** |
| 12 écrans structurants E01–E12 | **PRIORITÉ MAXIMALE DANS LE PROTOTYPAGE** |
| Qualification juridique des points W | **À FERMER AVANT PROMESSE CONCERNÉE** |
| Volumétrie / RPO / RTO | **OBJECTIFS À MESURER, PAS SLA ACQUIS** |
| Golden DCE A1 | **PEUT ÊTRE FINALISÉ EN PARALLÈLE** |
| A2 SourceAnchor | **HOLD** |

## 58.2 Prochain chantier produit

### Étape 1 — Catalogue complet

Produire :

> `SMART_AO_Catalogue_Ecrans_Parcours_Produit_v0.1.md`

Ce catalogue doit couvrir **tous les écrans et parcours V1**, depuis la connexion jusqu’à la fermeture/export, y compris les états secondaires, erreurs et reprises. Il classera les écrans par priorité P1/P2/P3 et indiquera les dépendances de parcours.

### Étape 2 — Prototypage visuel complet

À partir de ce catalogue, concevoir visuellement l’ensemble de la surface V1. Les 12 écrans structurants sont réalisés en priorité et avec la plus forte profondeur :
...
Les écrans de compte, sécurité, organisation, Mémoire Entreprise, administration, partage, résultats, notifications, support, export et reprise sont conçus dans la même campagne selon leur criticité.

### Étape 3 — Validation propriétaire

Le propriétaire doit pouvoir parcourir SMART AO de bout en bout et répondre :

> **« Oui, c’est bien ce logiciel-là que je veux vendre et faire utiliser. »**

La validation porte sur le fonctionnement, les droits, les informations, les décisions, les états et la reprise — pas uniquement sur l’esthétique.

## 58.3 Critère de promotion

Lorsque le propriétaire valide le **catalogue complet**, la **surface UX V1 prototypée**, les contrats E01–E12/S01–S02 et qu’aucun écart C1 produit ne reste ouvert, une version propre et sans statut intermédiaire sera produite :

> `SMART_AO_Cahier_Directeur_Produit_Metier_OWNER_FREEZE_v1.0.md`

Cette version deviendra l’unique source normative propriétaire du produit.

## 58.4 Après v1.0

Seulement après ce gel :

1. cahier technique d’exécution ;
2. matrice des dépendances et benchmarks ;
3. architecture exécutoire ;
4. plan de migration V8 `KEEP / ADAPT / REPLACE / DELETE` ;
5. plan de PR Codex ;
6. reprise A2 puis A3/A4 selon gates.

Le cahier technique peut choisir les moyens, mais ne peut plus modifier silencieusement le produit.


---

# 59. Changelog v0.4-R1 — décision de couverture UX complète

Cette révision ne modifie ni la vision métier, ni DEC-01–11, ni le périmètre V1/V1.x, ni R01–R16.

Elle modifie la **condition de validation produit avant Product Freeze** :

- les 12 écrans E01–E12 restent structurants, mais ne sont plus la liste exhaustive de prototypage ;
- toute la surface fonctionnelle V1 doit désormais être inventoriée dans un catalogue dédié ;
- tous les écrans/parcours V1 doivent être conçus visuellement avec un niveau de fidélité adapté à leur criticité ;
- les parcours accès/sécurité, organisation, Mémoire Entreprise, administration, partage, export, erreur, reprise et fermeture font explicitement partie du gel UX ;
- le prochain livrable est `SMART_AO_Catalogue_Ecrans_Parcours_Produit_v0.1.md` ;
- A2 SourceAnchor reste HOLD jusqu’au Product Freeze v1.0.

**Décision propriétaire : F — 13 septembre 2026.**

---

**Fin — Owner Consolidated v0.4**
